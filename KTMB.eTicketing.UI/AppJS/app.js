(function () {
    ...
    app.factory('apiURL', ['$window', '$location', function ($window, $location) {
       ...
       // return 'https://eticket.ktmb.com.my/devapi';
        return 'http://localhost:54253';      //  home
    ...
    app.factory('baseURL', ['$window', '$location', function ($window, $location) {
        ...
        // new  var url = "https://eticket.ktmb.com.my";//For deployment only  


        //var url = "http://www.ktmb.com.my";//For deployment only  
    ...
    app.factory('cmsURL', ['$window', '$location', function ($window, $location) {
        ...
        var url = "https://eticket.ktmb.com.my/cms_api";
        return url;
    }]);
